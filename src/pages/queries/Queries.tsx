                      ...
                      <div className='flex flex-col gap-y-4 p-4 bg-creamy rounded-2xl'>
                        <div className='flex justify-between items-start'>
                          ...
                          <div className='bg-white rounded-md px-2 py-1'>
                            <Text type='label' color='vermilion' className='!text-xs'>{item.usage.total_tokens}</Text>
                          </div>
                        </div>
                        <div className='flex justify-between items-center'>
                          <Text type='paragraph' color='gray' className='!text-xs'>Prompt: {item.usage.prompt_tokens} tks.</Text>
                          <Text type='paragraph' color='gray' className='!text-xs'>Completion: {item.usage.completion_tokens} tks.</Text>
                        </div>
                      </div>
                    </Link>
                  ))
