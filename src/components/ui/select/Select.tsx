    ...
    <div className={`text-left ${className}`}>
      ...
      <ReactSelect
        ...
        classNames={{
          ...
          valueContainer: () => `!px-4`,
          placeholder: () => `!text-[13px] !mx-0 font-poppins font-normal !text-slate-400 !group-hover:text-slate-500`,
          input: () => `!text-[13px] !m-0 !py-0 font-poppins font-normal !text-slate-400 !group-hover:text-slate-500`,
          singleValue: () => `!text-[13px] !mx-0 font-poppins font-normal !text-slate-500`,
