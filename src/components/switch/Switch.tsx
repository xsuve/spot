...
const Switch: FC<SwitchProps> = ({
  ...
  return (
    <div
      className={`w-[32px] h-[12px] relative flex items-center rounded-lg cursor-pointer transition-all ease-linear ${disabled ? 'bg-gray-100' : (toggled ? 'bg-yellow-200' : 'bg-white')}`}
